...
def create_app(db_url=None):
    ...
    app.config["JWT_SECRET_KEY"] = "314748447504835740788900657857884704531"
        # generated secret key from terminal w/ python >>> import secrets >>> secrets.SystemRandom().getrandbits(128)
    jwt = JWTManager(app)
    ...
    #def add_claims_to_jwt(identity):
        # Better to look in the db to see if the user is an admin
        #if identity == 1:
